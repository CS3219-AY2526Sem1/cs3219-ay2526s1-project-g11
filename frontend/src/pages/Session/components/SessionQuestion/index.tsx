  ...
  return (
    <div className="w-full h-full bg-white rounded-xl shadow-lg p-4 flex flex-col gap-4">
      ...
      <div className="flex items-center text-sm gap-2">
        ...
        <button className="ml-auto cursor-pointer bg-gray-100 border hover:bg-gray-200 active:bg-gray-300 border-gray-300 px-2 py-1 rounded-lg flex gap-2 items-center justify-center">
          <SparklesIcon className="h-3 w-3" />
          Explain Code
        </button>
        <button className="cursor-pointer bg-gray-100 border hover:bg-gray-200 active:bg-gray-300 border-gray-300 px-2 py-1 rounded-lg flex gap-2 items-center justify-center">
          <SparklesIcon className="h-3 w-3" />
          Get Hint
        </button>
      </div>
